...
file_path = input("Podaj ścieżkę do pliku z liczbą binarną: ")
output_file_path = input(
    "Podaj ścieżkę do pliku, gdzie chcesz zapisać reprezentację heksadecymalną: ")

binary_input = process_binary_file(file_path)
